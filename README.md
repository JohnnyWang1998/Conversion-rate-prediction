...
The project mainly consists of two part: EDA (Explanatory Data Analysis) and Modeling
## Introduction
...
## Configuration
To run this project, you need to make sure your local machine meets the requirements presented in `requirements.txt`
## Modeling structure
```
Modeling.ipynb
│   Data Import    
